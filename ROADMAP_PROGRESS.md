...
|---|---|
| **Date** | 2026-08-30 |
| **Overall progress** | **80%** of the milestone arc (MS-0 → GA) — up from 75% at the extension-kit sprint (measured: milestone board average, `tools/status.ts` → `site-data/vaerion-status.json`; MS-6 in progress at 40% — the reproducible-bundles exit criterion is complete, installers / docs sweep / accessibility / performance double-check remain) |
