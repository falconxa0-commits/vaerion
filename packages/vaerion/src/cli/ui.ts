...
function aiReport(a: Ansi, obj: Obj, width: number): string[] {
  ...
  out.push(...panel(a, {
    ...
    width,
    accent: "gold",
    subtitle: "the ONE research pipeline → the gateway single gate (constitution v1.4 A3)",
  }));
  out.push("");
  out.push(...panel(a, {
    title: "Answer",
...
function centerReport(a: Ansi, obj: Obj, width: number): string[] {
  ...
  out.push(...panel(a, {
    ...
    subtitle: "constitution v1.4 A3 · one measured core · read-only (D-S)",
  }));
...
function accountReport(a: Ansi, obj: Obj, width: number): string[] {
  ...
  out.push(...panel(a, {
    ...
    width,
    accent: "gold",
    subtitle: "constitution v1.4 A3 · P5 attribution · D-D actor+cause · local identity, never a cloud account",
  }));
