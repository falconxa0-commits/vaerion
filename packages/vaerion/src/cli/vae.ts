...
Learn more: docs/constitution/VAERION_CONSTITUTION_v1.4.md · spec/ (contracts)
`;
...
const COMMAND_HELP: Record<string, string> = {
  ...
  the deterministic template registry (constitution v1.4 A3, Phase 5):
...
vae ci simulate --event push|pull_request|workflow_dispatch|tag [--ref NAME]
  ...
  The identity & attribution surface (constitution v1.4 A3, Phase 3;
...
vae ai models
  ...
  ask (constitution v1.4 A3, Phase 4; P8/D-J/D-O) — the grounded question:
  ...
  The operator cockpit (constitution v1.4 A3, Phase 6; P7/D-S). Read-only.
