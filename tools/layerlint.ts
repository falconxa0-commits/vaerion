...
function layerOf(relPath: string): Layer | null {
  ...
  if (p.startsWith("runtime/") || p.startsWith("research/") || p.startsWith("agents/") || p.startsWith("workflow/") || p.startsWith("evals/") || p.startsWith("extensions/") || p.startsWith("package/") || p.startsWith("repo/") || p.startsWith("identity/") || p.startsWith("center/")) return "L2";
