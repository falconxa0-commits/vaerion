...
const status = {
  ...
  verification,
  tests: { suites: 32, assertedExpectations: 2664, totalTests: 410, coverage: { lines: 86.75, branches: 91.22, floors: "bunfig.toml coverageThreshold (OBJ-Q6, ratcheted at MS-6 bundle close: 0.86/0.74/0.86/0.90; held at every ASCENSION phase close)" }, note: "counts from the latest full run of `bun test tests/ --coverage`" },
  ...
  nextWork: [
    "THE GA CAMPAIGN (Phases 7–10, v1.4 A4): Phase 7 (the performance budget law) complete — verify.ts now carries SEVEN gates; Phase 8 (the accessibility law) is next; Phase 9 (release-train rehearsal) and Phase 10 (the GA gate) follow.",
    "MS-6 remaining exit criteria: accessibility sweep (Phase 8) + native single-binary installers (host-gated: brew/winget/dmg/rpm authored in Phase 1, awaiting their platforms); then the daemon packages route group (wire parity, spec/openapi regen).",
