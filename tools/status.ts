...
const status = {
  ...
  verification,
  tests: { suites: 14, assertedExpectations: 1405, totalTests: 183, coverage: { lines: 83.37, branches: 88.96, floors: "bunfig.toml coverageThreshold (OBJ-Q6, ratcheted at MS-3)" }, note: "counts from the latest full run of `bun test tests/ --coverage`" },
  ...
  nextWork: [
    "MS-4: agent executor over journaled decisions; workflow DAGs on the spine; hermetic evals (cassette/MockBrain per ADR-0012).",
