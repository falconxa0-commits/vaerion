...
const status = {
  ...
  nextWork: [
    "Release train steps 3-5 (publish, announce, key ceremony) — Founder-gated at remote provisioning; v0.1.7-rc1 artifacts are reproducible via tools/dist-pack.ts.",
